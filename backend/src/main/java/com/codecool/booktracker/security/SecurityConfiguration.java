package com.codecool.booktracker.security;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.GET, "/api/search/books/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/bookshelf/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/bookshelf/**").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/bookshelf/**").permitAll()
